...
// these enums are duplicated from their namespaces into globals
const GLOBAL_ENUM_NAMESPACES = [
  "LogicSlotType",
  "LogicType"
];
exports.GLOBAL_ENUM_NAMESPACES = GLOBAL_ENUM_NAMESPACES;
const ENUM_MEMBERS = [
  "AirCon.Cold",
  "AirCon.Hot",
  "AirControlMode.Draught",
  "AirControlMode.None",
  "AirControlMode.Offline",
  "AirControlMode.Pressure",
  "ColorType.Black",
  "ColorType.Blue",
  "ColorType.Brown",
  "ColorType.Gray",
  ...
  "LogicType.RequestHash",
  "LogicType.RequiredPower",
  "LogicType.Reset",
  "LogicType.ReturnFuelCost",
  "LogicType.Richness",
  "LogicType.Rpm",
  "LogicType.SemiMajorAxis",
  "LogicType.Setpoint",
  "LogicType.Setting",
  "LogicType.SettingInput",
  "LogicType.SettingOutput",
  "LogicType.SignalID",
  "LogicType.SignalStrength",
  "LogicType.Sites",
  "LogicType.Size",
  "LogicType.SizeX",
  "LogicType.SizeY",
  "LogicType.SizeZ",
  "LogicType.SolarAngle",
  "LogicType.SolarIrradiance",
  "LogicType.SoundAlert",
  "LogicType.StackSize",
  "LogicType.Stress",
  "LogicType.Survey",
  "LogicType.TargetPadIndex",
  ...
  "LogicType.VelocityZ",
  "LogicType.Vertical",
  "LogicType.VerticalRatio",
  "LogicType.Volume",
  "LogicType.VolumeOfLiquid",
  ...
  "ShuttleType.Large",
  "ShuttleType.LargeGas",
  "ShuttleType.LargePlane",
  "ShuttleType.Medium",
  "ShuttleType.MediumGas",
  "ShuttleType.MediumPlane",
  "ShuttleType.None",
  "ShuttleType.Small",
  "ShuttleType.SmallGas",
  ...
  "SlotClass.RocketPayload",
  "SlotClass.ScanningHeat",
  ...
  "TraderInstruction.WriteTradeData",
  ...
  "Minimum",
  "Sum",
  "Contents", // LogicReagentMode
  "Recipe",
  "Required",
  "TotalContents",
];
exports.ENUM_MEMBERS = ENUM_MEMBERS;
